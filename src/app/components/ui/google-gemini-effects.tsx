...
export const GoogleGeminiEffect = ({
  ...
  const svgHeight = smallScreenSize ? "2200" : "490";
  ...
  return (
    <div className={cn("sticky top-80", className)}>
      ...
      <p className="lg:text-[2rem] md:text-xl font-normal text-center text-neutral-400 mt-4 mx-auto">
